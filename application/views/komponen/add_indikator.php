<form id="modalForm">
    ...
    <input type="hidden" name="skom_id" value="<?php echo $skom->skom_id;?>">
    <div class="col-md-10">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea name="ind_content" id="ind_content" class="form-control"></textarea>
        </div>
    </div>
    <div class="col-md-12">
...
<script>
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'komponen/add_indikator_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dt) {
