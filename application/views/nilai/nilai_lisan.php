<form id="modalForm">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label class="control-label" for="nt_nilai">Nilai Lisan (min 0 max 100)</label>
            <input id="nt_nilai" name="nt_nilai" type="number" min="0" max="100" step="1" class="form-control" value="<?php echo $data->np_nilai;?>">
        </div>
    </div>
    <div class="col-md-12">
...
<script>
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'nilai/nilai_lisan_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dt) {
