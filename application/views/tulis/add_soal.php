<form id="modalForm">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="hidden" name="soal_nomor" value="<?php echo $nomor; ?>">
        </div>
    </div>
    <div class="col-md-9">
        <div class="form-group">
            <label class="control-label">Mata Pelajaran</label>
            <input type="text" disabled value="<?php echo $data->mapel_name;?>" class="form-control">
        </div>
    </div>
...
<script>
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'tulis/add_soal_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dt) {
