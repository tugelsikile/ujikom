<form id="modalForm">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" disabled class="form-control" value="<?php echo $data->soal_nomor; ?>">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label class="control-label">Nomor Pilihan Ganda</label>
            <input type="text" disabled class="form-control" value="<?php echo $nomor; ?>">
            <input type="hidden" name="pg_nomor" value="<?php echo $pg; ?>">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="">
                <label for="is_right_ya"><input type="radio" name="is_right" id="is_right_ya" value="1"> Ya</label>&nbsp;&nbsp;&nbsp;
                <label for="is_right_no"><input type="radio" name="is_right" id="is_right_no" value="0" checked> Tidak</label>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea name="soal_content" id="soal_content" class="form-control" placeholder="Place some text here"></textarea>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-12">
...
<script>
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'tulis/add_pg_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dt) {
                if (dt.t == 0){
                    ...
                    $('.soal_'+dt.soal_id).append(dt.html);
                    show_msg(dt.msg);
